...
export const REAL_AWARDS = [
  ...
  { vendor: "Amplitude",    programId: "amplitude-startups", lane: "Business",
    value: { label: "1 yr Growth plan", estimate: null, cashLike: false }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Growth plan is custom-priced (no public list price) — excluded from totals rather than estimated." },
  ...
  { vendor: "Lightfield",   programId: null, lane: "Business",
  ...
  { vendor: "Framer",       programId: null, lane: "Multimedia",
  ...
  { vendor: "Linear",       programId: null, lane: "DevOps",
  ...
  { vendor: "Depot",        programId: null, lane: "DevOps",
  ...
  { vendor: "Algolia",      programId: "algolia-startups", lane: "DevOps",
    value: { label: "$10,000 credits", estimate: 10000, cashLike: true }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026", notes: "" },
  { vendor: "Retool",       programId: null, lane: "Business",
  ...
  { vendor: "Galaxy Cloud", programId: null, lane: "DevOps",
    value: { label: "$600 credits", estimate: 600, cashLike: true }, term: null,
    verificationStatus: "official", source: "active-credits-07-10-2026", notes: "" },
  { vendor: "Customer.io",  programId: null, lane: "Business",
    value: { label: "1 yr startup plan ($200/mo)", estimate: 2400, cashLike: true }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Rate stated in source ($200/mo)." },
  { vendor: "Confluent",    programId: null, lane: "DevOps",
  ...
  { vendor: "Mixpanel",     programId: "mixpanel-startup", lane: "Business",
    value: { label: "1 yr Startup plan", estimate: null, cashLike: false }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Vendor markets the program at $145k (1B events, full suite; mixpanel.com/startups 2026-07-10) — not counted in totals; no comparable list price." },
  { vendor: "SendPulse",    programId: null, lane: "Business",
    value: { label: "$5,000 credits + 5 domains", estimate: 5000, cashLike: true }, term: null,
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Includes 5 free domains (uncounted)." },
  { vendor: "Replit",       programId: null, lane: "DevOps",
  ...
  { vendor: "Bubble",       programId: null, lane: "DevOps",
    value: { label: "$500 credits", estimate: 500, cashLike: true }, term: null,
    verificationStatus: "official", source: "active-credits-07-10-2026", notes: "" },
  ...
  { vendor: "Make",         programId: null, lane: "Business",
  ...
  { vendor: "Confidence (Spotify)", programId: null, lane: "Business",
  ...
  { vendor: "Reducto",      programId: null, lane: "Tech & AI",
    value: { label: "$3,000 credits", estimate: 3000, cashLike: true }, term: null,
    verificationStatus: "official", source: "active-credits-07-10-2026", notes: "" },
  { vendor: "Oro (Tomorro)", programId: null, lane: "Business",
    value: { label: "$3,000 credits", estimate: 3000, cashLike: true }, term: null,
    verificationStatus: "official", source: "active-credits-07-10-2026", notes: "" },
  { vendor: "Jam",          programId: null, lane: "DevOps",
    value: { label: "1 yr Team plan ($170)", estimate: 170, cashLike: false }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Total value stated in source." },
  { vendor: "Gravatar",     programId: null, lane: "Business",
    value: { label: "1 yr free incl. domain", estimate: null, cashLike: false }, term: "12 mo",
    verificationStatus: "official", source: "active-credits-07-10-2026",
    notes: "Includes a free domain for 1 yr; no list price recorded — excluded from totals." },
  { vendor: "Anam",         programId: null, lane: "Multimedia",
  ...
  { vendor: "Fin AI Startup Pack", programId: null, lane: "Business",
