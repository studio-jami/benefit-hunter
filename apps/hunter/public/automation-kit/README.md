...
control. Nothing is sent to Jami Studio or any third party, and Jami Studio
never sees your email, your Sheet, or your key.

Full step-by-step guide: [docs/product/automation-kit-guide.md](https://github.com/studio-jami/benefit-hunter/blob/main/docs/product/automation-kit-guide.md)
in the [Benefit Hunter](https://benefits.jami.studio) repository.
...
- No data leaves Google's infrastructure except the Gemini API call, made
  with your key.
- To stop everything: delete the triggers (Apps Script editor > Triggers,
  or run `installTriggers` after removing the trigger code) and remove the
